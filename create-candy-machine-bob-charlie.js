...
async function createCandyMachineForBobCharlie() {
  try {
    console.log('🍭 Step 2: Creating Candy Machine for Bob & Charlie Test Collection...');
    
    const collectionId = 'collection_1761424406184_l9r6wxizg';
...
createCandyMachineForBobCharlie().then(result => {
  if (result) {
