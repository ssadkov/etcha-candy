...
async function checkCharlieMintedNFT() {
  try {
    const nftAddress = '12TZd8baHF7KJk7c6ZcS1LnPLvZnVXXDt6nE1fs87Uvn';
    console.log('🎫 Checking Charlie\'s minted NFT:', nftAddress);
