...
async function checkExistingCandyMachine() {
  try {
    console.log('🔍 Checking existing Candy Machine...');
    ...
    console.error('❌ Error checking existing Candy Machine:', error.message);
    return null;
  }
}

checkExistingCandyMachine().then(result => {
  if (result) {
    console.log('\n🎉 Found working Candy Machine!');
    console.log('📊 Summary:');
    ...
    console.log('\n❌ No working Candy Machine found');
  }
});
